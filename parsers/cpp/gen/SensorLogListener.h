...
public:
  ...
  virtual void
  enterDeviceDefinitions(SensorLogParser::DeviceDefinitionsContext *ctx) = 0;
  virtual void
  exitDeviceDefinitions(SensorLogParser::DeviceDefinitionsContext *ctx) = 0;

  virtual void
  enterDeviceDefinition(SensorLogParser::DeviceDefinitionContext *ctx) = 0;
  virtual void
  exitDeviceDefinition(SensorLogParser::DeviceDefinitionContext *ctx) = 0;

  virtual void
  enterDeviceContent(SensorLogParser::DeviceContentContext *ctx) = 0;
  virtual void
  exitDeviceContent(SensorLogParser::DeviceContentContext *ctx) = 0;
  ...
  virtual void
  enterSensorDefinition(SensorLogParser::SensorDefinitionContext *ctx) = 0;
  virtual void
  exitSensorDefinition(SensorLogParser::SensorDefinitionContext *ctx) = 0;
  ...
  virtual void
  enterSensorNamePart(SensorLogParser::SensorNamePartContext *ctx) = 0;
  virtual void
  exitSensorNamePart(SensorLogParser::SensorNamePartContext *ctx) = 0;
  ...
  virtual void
  enterUnitOfMeasurement(SensorLogParser::UnitOfMeasurementContext *ctx) = 0;
  virtual void
  exitUnitOfMeasurement(SensorLogParser::UnitOfMeasurementContext *ctx) = 0;
